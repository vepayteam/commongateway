...
class KfOutParts extends Model
{
    public $amount = 0;
    public $extid = '';
    public $document_id = '';
    ...
    */
    ...
    public function rules()
    {
        return [
            ...
            [['amount'], 'validateAmount', 'on' => [self::SCENARIO_UL, self::SCENARIO_STATE]],
            [['parts'], 'required', 'on' => [self::SCENARIO_UL, self::SCENARIO_STATE]],
            [['parts'], 'validateParts', 'on' => [self::SCENARIO_UL, self::SCENARIO_STATE]],
        ];
    }
