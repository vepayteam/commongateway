FROM registry.vepay.dev/library/php:7.2 as base
...
#FROM registry.vepay.dev/library/php:7.2 as vendor
#
...
#
#FROM registry.vepay.dev/library/php:7.2 as assets
#
...
FROM registry.vepay.dev/library/php:7.2 as dev
