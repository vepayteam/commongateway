...
function _topNav() {
    ...
    jQuery("#topHead .dropdown-menu, #topNav .mega-menu .dropdown-menu").on("click", function (e) {
        e.stopPropagation();
    });
...
function _globalSearch() {
    ...
    jQuery('li.search, li.search input').on("click", function (e) {
        e.stopPropagation();
    });

    jQuery('li.search input').on("click", function () {
        return false;
    });
...
function _quickCart() {
    ...
    jQuery('li.quick-cart').on("click", function () {

        jQuery('li.quick-cart .quick-cart-content').on("click", function (e) {
            e.stopPropagation();
        });
